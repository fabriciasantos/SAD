...
BEGIN
	...
	WHILE (@@FETCH_STATUS = 0)
		BEGIN
		DECLARE @COD_DATA INT, @COD_EMPRESA INT
		SELECT * FROM TB_Academia
		/*
			O CAMPO DA FAIXA ETARIA NA TABELA DE ALUNO É UM VARCHAR, POREM NA AUXILIAR DO FATO PEDE UM INT, ENTAO BUSQUEI NA DIMENSAO
			FAIXA ETARIA, AMANHÃ PERGUNTAMOS A ANDRÉ SE ISSO ESTÁ CORRETO
		*/
		...
		INSERT INTO TB_AUX_FLUXO(DATA_CARGA,FLU_Codigo,FLU_CodigoData,FLU_HorarioEntrada,FLU_HorarioSaida,FLU_CodAluno,FLU_CodEmpresa,FLU_CodFaixaEtaria,FLU_CodLocalizacao,FLU_CodTurno)
								VALUES (@DATACARGA,@CODIGO_FLUXO,@COD_DATA,@DATA_ENTRADA,@DATA_SAIDA,@CODIGO_ALUNO,@COD_EMPRESA,@CODIGO_FAIXA_ETARIA,@END_CODIGO,@TUR_CODIGO)         
