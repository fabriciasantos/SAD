...
BEGIN
	...
	WHILE (@@FETCH_STATUS = 0)
		...
		select @ACA_CODIGO = u.ACA_Codigo from tb_usuario u
							INNER JOIN tb_aluno a ON (a.ALU_Codigo = @CODIGO_ALUNO)
